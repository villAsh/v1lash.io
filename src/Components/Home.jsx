...
export default function Home() {
  ...
  return (
    ...
    >
      <h1 className="text-4xl md:text-7xl text-light-fg dark:text-light-text my-5 text-center">
        Hi , I am <span className="text-light-primary">Vilas Chauvhan</span>
      </h1>
      ...
      <p className="text-justify md:text-left  text-xl text-light-fg dark:text-light-text px-5 md:px-0 mx-5">
        A <span className="text-light-primary">Software Engineer</span> and{" "}
        <span className="text-light-primary">Computer Science Enthusiast</span>{" "}
        Who loves building <span className="text-light-primary">Web Apps</span>{" "}
        and <span className="text-light-primary">Solving Problems</span>. During
        my College journey i have Learned various{" "}
        <span className="text-light-primary">Tools</span> and{" "}
        <span className="text-light-primary">Technologies</span>.
      </p>
      <ul className="flex flex-col space-y-5 sm:space-y-0 sm:flex-row sm:items-center sm:space-x-5 my-5 text-3xl">
        {links.map((item) => (
          <li
            className={`relative group sm:hover:cursor-pointer`}
            key={item.id}
          >
            <a
              href={`${item.link}`}
